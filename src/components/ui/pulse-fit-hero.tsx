...
export function PulseFitHero({
  ...
  return (
    <section
      className={cn(
        'relative w-full min-h-screen flex flex-col overflow-hidden pt-40 ',
        className
      )}
      style={{
        background:
          'linear-gradient(180deg, #FAF7F2 0%, #F5F9FF 50%, #FAF7F2 100%)',
      }}
      role="banner"
      ...
      {children ? (
        ...
        <div className="relative z-10 flex-1 flex flex-col items-center justify-center px-4">
          ...
          >
            <Badge
              variant="secondary"
              className="uppercase text-[10px] lg:text-xs bg-white"
            >
              Our Philosophy
            </Badge>
            {/* Title */}
